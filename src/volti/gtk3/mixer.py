...
class Mixer(Gtk.Window):
    ...
    def init_controls(self):
        ...
        for card_index, card_name in enumerate(self.acards):
            ...
            self.notebook.insert_page(frame, Gtk.Label(label=card_name), card_index)
...
class MixerControl(Gtk.Frame):
    ...
    __gsignals__ = {
            'volume_changed': (GObject.SignalFlags.RUN_LAST,
                GObject.TYPE_BOOLEAN, (GObject.TYPE_INT,
                    GObject.TYPE_INT, GObject.TYPE_INT, GObject.TYPE_INT)),
            'volume_setting_toggled': (GObject.SignalFlags.RUN_LAST,
                GObject.TYPE_BOOLEAN, (GObject.TYPE_INT,
                    GObject.TYPE_INT, GObject.TYPE_INT, GObject.TYPE_INT))
        }
    ...
    def __init__(self, channel, option_mask, option_value,
        ...
        volume1_control.set_value_pos(Gtk.PositionType.TOP)
        ...
        if self.stereo:
            ...
            volume2_control.set_value_pos(Gtk.PositionType.TOP)
